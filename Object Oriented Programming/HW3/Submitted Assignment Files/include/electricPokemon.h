...
// This class inherited from the class Pokemon provides creating an electric Pokemon.

class electricPokemon : public Pokemon{
    public:
        electricPokemon(const string name, const int hp, const int damage); // constructor
